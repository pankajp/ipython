...
class ConsoleWidget(LoggingConfigurable, QtGui.QWidget):
    ...
    def _flush_pending_stream(self):
        ...
        # Set the flush interval to twice the maximum time to update text.
        self._pending_text_flush_interval.setInterval(max((time.time()-t)*1000,
                            self._pending_text_flush_interval.interval()))
